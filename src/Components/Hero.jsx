        ...
        <div className="row">
          <div className="col-lg-4">
            <div className="profile-card bg-gray-600  flex flex-col items-center rounded-[20px] p-4">
              <img
                src={profile}
                className="profile w-40 h-40 mb-4 object-cover"
                alt="profile image"
              />

              <div className="content">
                <div className="title text-white text-3xl text-center">
                  Birgül Demirden
                </div>
                <div className="job-title text-center text-gray-400">
                  Front-end Developer
                </div>
                <div className="short-text text-white text-center mt-2 text-sm">
                  Sakarya Üniversitesi Matematik Bölümü mezunuyum. 1 yıldır bir
                  ajans bünyesinde Front-end Developer olarak çalışıyor,
                  kullanıcı odaklı arayüzler geliştiriyorum.
                </div>
                <ul className="p-3">
                  <li className="text-white">
                    ...
                    <a
                      ...
                      target="_blank"
                    >
                      birgulozhan9@gmail.com
                    </a>
                  </li>
                  <li className="text-white">
                    Linkedin:{" "}
                    <a
                      href="www.linkedin.com/in/birgül-demirden"
                      className="underline"
                      target="_blank"
                    >
                      https://www.linkedin.com/in/birgul-ozhan00/
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div className="col-lg-8 flex justify-center">
            <div className="relative pl-1 border-l-2 border-gray-600">
              {/* Proje Kutusu 1 */}
              <div
                href="https://www.serrezistans.com/"
                className="relative mb-10 w-[350px]"
              >
                {/* Nokta */}
                <div className="absolute -left-3 top-2 w-4 h-4 rounded-full bg-blue-500 border-2 border-white"></div>

                {/* Kutunun kendisi */}
                <div className="bg-white rounded-2xl shadow-md overflow-hidden transition hover:shadow-xl hover:scale-[1.01] ml-4 max-w-[600px]">
                  <img
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Click to Peak bünyesinde front-end developer olarak
                      çalıştığım dönemde Laravel Blade yapısı kullanarak CMS
                      sistemiyle ön yüzünü kodladım.
                    </p>
                  </div>
                </div>
              </div>
